 ...
 *
 */
public class YCVoiceRecorderView extends RelativeLayout {
    protected Context context;
    protected LayoutInflater inflater;
    protected Drawable[] micImages;
    protected YCVoiceRecorder voiceRecorder;
    ...
    public YCVoiceRecorderView(Context context) {
        super(context);
        init(context);
    }

    public YCVoiceRecorderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public YCVoiceRecorderView(Context context, AttributeSet attrs, int defStyle) {
...
//        recordingHint = (TextView) findViewById(R.id.recording_hint);
     ...
     * @param event
     */
    public boolean onPressToSpeakBtnTouch(View v, MotionEvent event, YCVoiceRecorderCallback recorderCallback) {
...
//                    Toast.makeText(context, R.string.send_failure_please, Toast.LENGTH_SHORT).show();
    ...
    public interface YCVoiceRecorderCallback {
        /**
         * 录音完毕
         * 
         * @param voiceFilePath
    ...
    public void startRecording() {
        if (!YCCommonUtils.isExitsSdcard()) {
            Toast.makeText(context, "sd 卡不存在", Toast.LENGTH_SHORT).show();
            return;
        }
        try {
            wakeLock.acquire();
            ...
            Toast.makeText(context, "录音失败，请重新录音", Toast.LENGTH_SHORT).show();
            return;
        }
    }
