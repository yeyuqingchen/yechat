...
@SuppressLint("NewApi")
public class YCEmojiconIndicatorView extends LinearLayout{
    ...
    public YCEmojiconIndicatorView(Context context, AttributeSet attrs, int defStyle) {
        this(context, null);
    }

    public YCEmojiconIndicatorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public YCEmojiconIndicatorView(Context context) {
        this(context,null);
    }
