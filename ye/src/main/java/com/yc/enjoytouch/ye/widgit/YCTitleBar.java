 ...
 *
 */
public class YCTitleBar extends RelativeLayout{
    ...
    public YCTitleBar(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }

    public YCTitleBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
